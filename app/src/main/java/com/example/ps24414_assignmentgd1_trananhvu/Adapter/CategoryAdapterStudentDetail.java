...
public class CategoryAdapterStudentDetail extends ArrayAdapter<Category> {


    public CategoryAdapterStudentDetail(@NonNull Context context, int resource, @NonNull List<Category> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.category_spinner_detailstudent, parent, false);
